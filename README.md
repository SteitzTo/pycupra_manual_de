...
uv sync
```
um die Abhängigkeiten des pycupra Packetes zu installieren. 
...
username: Hier die E-Mail-Adresse eintragen welches ihr in der Cupra/Seat App benutzt.<br>
...
## 6. Firebase Messaging abschalten 
...
```
Vorsicht: Wenn man Änderungen an der PyCupra.py durchführt, ist das natürlich nicht mehr updatefest und muss nach einem git pull wieder ergänzt/geändert werden.
